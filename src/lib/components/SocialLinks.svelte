...
<style>
	...
	.item-content a[data-social='instagram'] ::before {
		background: linear-gradient(45deg, #405de6, #5b51db, #b33ab4, #c135b4, #e1306c, #fd1f1f);
	}

	.item-content a[data-social='youtube'] .filled,
	.item-content a[data-social='youtube'] ::before {
		background-color: #ff0000;
	}

	.item-content a[data-social='linkedin'] .filled,
	.item-content a[data-social='linkedin'] ::before {
		background-color: #0a66c2;
	}

	.item-content a[data-social='twitter'] .filled,
	.item-content a[data-social='twitter'] ::before {
