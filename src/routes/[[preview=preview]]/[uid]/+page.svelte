...
<Bounded>
	<div class="diagonal w-full p-8 mb-10 h-40 relative flex flex-col items-center text-center">
...
<style>
	.diagonal {
		--skew-angle: -2deg;
		--background: linear-gradient(45deg, var(--color-primary), #c471ed, var(--color-accent));
